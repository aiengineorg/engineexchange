      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="bg-white/[0.02] subtle-border p-10 space-y-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="font-mono text-xs font-bold text-bfl-green uppercase tracking-[0.5em]">Registration Protocol</h2>
            <div className="h-px flex-1 blueprint-line" />
          </div>
          ...
          <div className="space-y-6">
            <button
              ...
              className="w-full px-10 py-5 bg-white text-bfl-black rounded-sm font-medium text-sm uppercase tracking-[0.2em] flex items-center justify-center gap-3 hover:bg-bfl-offwhite transition-all transform hover:translate-y-[-2px]"
            >
              <svg
                className="h-5 w-5"
                fill="currentColor"
            ...
            <div className="relative">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full h-px blueprint-line" />
              </div>
              <div className="relative flex justify-center">
                <span className="bg-bfl-black px-4 font-mono text-[10px] text-bfl-muted uppercase tracking-[0.3em]">
            ...
            <AuthForm action={handleSubmit} defaultEmail={email}>
              ...
              <p className="mt-4 text-center text-bfl-muted text-sm">
                {"Already have an account? "}
                <Link
                  className="font-normal text-white hover:text-bfl-green transition-colors"
                  href="/login"
                >
                  Sign in
                </Link>
